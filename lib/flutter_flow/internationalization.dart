...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // homePage_alt
  {
    ...
    '7zcrtqx6': {
      'en': 'We have a First 2 Digit Winner, Claim via Gcash!',
      'ar': 'لقد لاحظنا تكلفة صغيرة خارجة عن طبيعة هذا الحساب ، يرجى المراجعة.',
      'de':
          'Wir haben eine kleine Belastung festgestellt, die für dieses Konto untypisch ist. Bitte überprüfen Sie diese.',
      'es':
  ...
  // bookAppointment
  {
    ...
    '7ohalsg9': {
      'en': 'Where did you hear about our offer?',
      'ar': 'ما هي المشكلة؟',
  ...
  // Miscellaneous
  {
    ...
    'gdadxppp': {
      'en':
          'In order to record voice, This app requires permission to access the microphone.',
      'ar': '',
      'de': '',
      'es': '',
    },
