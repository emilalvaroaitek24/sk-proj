...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF5AC8FA);
  late Color secondary = const Color(0xFFB3E5FC);
  late Color tertiary = const Color(0xFFE1F5FE);
  late Color alternate = const Color(0xFF8ED5F7);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFF0288D1);
  ...
  late Color accent2 = const Color(0xFFFFFF8D);
  late Color accent3 = const Color(0xFF8BC34A);
  late Color accent4 = const Color(0xFFFFAB91);
