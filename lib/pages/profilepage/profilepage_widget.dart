                    ...
                    AuthUserStreamWidget(
                      builder: (context) => Text(
                        '₱${valueOrDefault<String>(
                          valueOrDefault(currentUserDocument?.totalBalance, 0)
                              .toString(),
                          '0.00',
                        )}',
                        style:
